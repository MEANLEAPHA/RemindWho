$(document).ready(function () {
  ...
  $('#task-form').on('submit', function (e) {
    ...
    const updatedTask = {
      ...
      start_time: toUTCString($('#startAt').val()),       // ✅ Fixed timezone issue
      deadline_time: toUTCString($('#EndAt').val()),     // ✅ Fixed timezone issue
    ...
    $.ajax({
      ...
      error: function (xhr) {
        $('#msg').text(xhr.responseText).css('color', 'red'); // ✅ Fixed typo
        console.error(xhr);
      }
    });
  });
